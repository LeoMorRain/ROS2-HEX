...
def generate_launch_description():
    ...
    urdf_file_path = os.path.join(
        get_package_share_directory("xpkg_urdf_mark2_mcnm"), "urdf", "sim_base.xacro"
    )
    ...
    visual_arg = DeclareLaunchArgument(
        name="visual",
        default_value="true",
        choices=["true", "false"],
    ...
    robot_state_node = Node(
        ...
        output="screen",
        parameters=[
            {"robot_description": description_content, "use_sim_time": use_sim_time}
        ],
    )
